...
def axis_angle_to_quaternion(axis_angle):
    """
    axis_angle: tensor (..., 3)
    returns: tensor (..., 4) in xyzw format
    """
...
def quaternion_to_axis_angle(quaternion):
    """
    quaternion: tensor (..., 4) in xyzw format
    returns: tensor (..., 3)
    """
...
def quaternion_multiply(q1, q2):
    ...
    q1_np = q1.reshape(-1, 4).detach().cpu().numpy()
    q2_np = q2.reshape(-1, 4).detach().cpu().numpy()

    r1 = R.from_quat(q1_np)
    r2 = R.from_quat(q2_np)
